...
setwd("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/data/common/hydrology/NetCDF files/Total Runoff")

savepath <- "C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/data/common/hydrology/NetCDF files/Total Runoff"
    ...
    for(variable in variables) {
      for ( year in 2006:2099){
        ...
        for ( i in filenames2 ){ 
          ...
          pth <- paste( savepath,"/", GCM,"/", rcp,"/" , sep="" )
          #if the directory doesn't exist, make it!
          if (!dir.exists(pth)){
            dir.create(file.path(pth), recursive = TRUE)
          }
          download.file( paste( GCM_dir , i , sep="" ) , paste(savepath,"/", GCM,"/", rcp,"/" , i, sep="" ) , mode="wb" )
        }	
      }
    }
  }
