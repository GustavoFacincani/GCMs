...
In this script I'm trying to extract data from a NetCDF files (raw data from http://albers.cnr.berkeley.edu/data/scripps/loca_vic-output/) using shapefiles 
of basins with multiple polygons (subbasins). First I tried doing it for one file, using one shapefile. Then, I create a function to do it automatically to 
multiple files.
